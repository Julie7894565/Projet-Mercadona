 ...
 */
final class Version20230416173018 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id SERIAL NOT NULL, product_category_id INT DEFAULT NULL, product_promotion_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, description VARCHAR(500) NOT NULL, price DOUBLE PRECISION NOT NULL, quantity INT NOT NULL, picture VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id SERIAL NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(id))');
